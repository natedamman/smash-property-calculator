...
fbq('init', '3390105951260014');
fbq('track', 'Lead');
</script>
<noscript><img height="1" width="1" style="display:none"
src="https://www.facebook.com/tr?id=3390105951260014&ev=PageView&noscript=1"
/></noscript>
<!-- End Meta Pixel Code -->
...
export function ResultsDashboard({ results, propertyInputs, financialInputs, investorType, qualification, leadScore, copy, wealthGoal }: Props) {
  ...
  return (
    <div className="space-y-8">
      ...
      <Tabs defaultValue={tabOrder[0]} className="w-full" onValueChange={(tab) => trackResultsView(tab)}>
